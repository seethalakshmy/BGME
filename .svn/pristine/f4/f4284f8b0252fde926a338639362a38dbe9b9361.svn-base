...
public class ResideMenu extends FrameLayout {
    ...
    private List<ResideMenuHeader> leftMenuheader;
    private List<ResideMenuHeader> rightMenuheader;
    ...
    private void initValue(Activity activity) {
        ...
        leftMenuheader=new ArrayList<ResideMenuHeader>();
        rightMenuheader=new ArrayList<ResideMenuHeader>();
     ...
     * @param direction
     */
    public void addMenuHeader(ResideMenuHeader menuItem, int direction) {
        if (direction == DIRECTION_LEFT) {
            this.leftMenuheader.add(menuItem);
            layoutLeftMenu.addView(menuItem);
        } else {
            this.rightMenuheader.add(menuItem);
